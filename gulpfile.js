...
function customizeBootstrap() {
  return src("src/scss/vendor/bootstrap_source/bootstrap.scss").pipe(sass()).pipe(rename("_bootstrap.scss")).pipe(dest("src/scss/inc"));
}

// DEV: Çalıştırmak için terminalde: gulp
exports.default = series(bsScssTask, jsTask, fileincludeTask, browsersyncServe, watchTask);
